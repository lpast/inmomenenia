...
(0589, 'venta', 'Calle Eras Altas', 86, null, null, 50171, 'La Puebla de Alfindén', 120, 3, 2, 'si', 'si', 'no', 'segunda mano', 'Casa en venta','Casa totalmente reformada y equipada, lista para entrar a vivir.', 150.000, 'fachada_0078.png', '2022-09-08', '74859657P'),
(0263, 'venta', 'Calle Cortes de Aragón', 63, null, null, 50195, 'La Puebla de Alfindén', 150, 1, 3, 'no', 'no', 'no', 'segunda mano', 'Oportunidad','Casa totalmente reformada y equipada, lista para entrar a vivir.', 99.000, 'fachada_0263.png','2022-09-08', '38693644L'),
...
(0890, 'venta', 'Sol', 54, '', '', 50171, 'La Puebla de Alfindén', 133, 3, 2, 0, 0, 1,  0, 'Casa en venta', 'Preciosa casa para una familia. Reformada y equipada hace pocos meses, lista para entrar a vivir.', 139.000, 'salon-rojo_0063.jpeg','2022-10-07', '39147258M'),
(0113, 'alquiler', 'Carretera Zaragoza',33, '3','', 50195, 'Pastriz', 90,  1, 1, 0, 0, 1, 0,'Casa en alquiler', 'Preciosa y acogedora casa totalmente reformada y equipada, ideal para parejas. Lista para entrar a vivir.', 400, 'fachada_0078.jpg','2022-05-08', '40324786C');
...
('20489695S', 'vender', 'Antonio', 'Camacho Perez', 692478963,'', 'Av. Teatro', 15, '1','A', 50195, 'Pastriz'),
...
('47896214H', 'comprar', 'Amparo', 'Sánchez Carrillo', 685633215, 'amp_san@yahoo.com', 'C/ industrial', 17, '2','3',50195, 'Pastriz'),
...
('11478215K', 'comprar', 'Rubén', 'Segura Romo', 664790808, '', 'Doctor Pareja Yébenes', 8, '3','D', 50171, 'La Puebla de Alfindén'),
...
('72146969B', 'vender', 'Andres', 'Lopez Panizo', 698475632, 'andres_lopez@medina.es','C/ Doctor Pareja Yében', 68, '3','C', 50171, 'La Puebla de Alfindén'),
('78596875P', 'vender','Pepe', 'Rodriguez Sancho', 976355896, 'pepesano@yahoo.com','Calle Hermita', 36, '4','D',50171, 'La Puebla de Alfindén');
...
(215, '2022-12-12', '11:00:00', 'Ver piso', 'Plaza de la Nava, 5', '40321567C'),
(011, '2023-01-15', '11:22:00', 'Entrega llaves piso','Carretera de la Sierra, 12', '89532541D'),
(0315, '2023-08-10', '17:00:00', 'Ver chalet', 'Carretera de la Sierra, 12', '40321567C'),
(0116, '2023-01-13', '09:00:00', 'Firma de papeles ático', 'Oficina','45805486A'),
(200, '2023-01-09', '13:00:00', 'Visitar piso', 'Calle rosales, 17', '47896214H'),
(210, '2023-02-16', '11:00:00', 'Ver piso', 'Plaza de la Nava, 5', '47896214H'),
(110, '2023-01-29', '12:22:00', 'Entrega llaves piso', 'C/ Pastriz, 44', '11478215K'),
(112, '2023-01-13', '10:22:00', 'Visitar piso', 'C/ Pastriz, 44', '45007784T'),
(111, '2023-02-28', '10:22:00', 'Visitar piso', 'C/ Almendro 26', '40321567C'),
(32, '2023-01-16', '09:22:00', 'Entrega llaves piso', 'C/ tortola, 44', '89658231F'),
(56, '2023-01-10', '11:22:00', 'Entrega llaves piso', 'C/ tortola, 44', '69147258M'),
(18, '2023-01-13', '11:22:00', 'Entrega llaves piso', 'C/ tortola, 44', '69147258M'),
(63, '2023-02-11', '11:22:00', 'Entrega llaves piso', 'Avd. de la Ermita, 53','40321567C'),
(045, '2023-05-20', '11:00:00', 'Firma de papeles ', 'Oficina', '40321567C');
