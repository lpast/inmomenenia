              ...
              <div class='panel-body'>
                ...
                <form class='form-horizontal' action='#' method='post'>
                  <div class='form-group'>
                    ...
                    <div class='form-group'>
                      <div class='col-sm-5 col-lg-offset-2'>
                        <input class='form-control btn-primary' type='submit' name='buscar' value='Buscar'>
                      </div>
                    </div>
                  </form>
                </div>
              ...
              <div class='form-group'>
                ...
                <div class='form-group'>
                  ...
                  <div class='form-group'>
                    <div class='col-sm-12 col-sm-offset-4'>
                      <div class='col-sm-2'>
                        <input class='form-control btn-primary' type='submit' name='modificar' value='Modificar'>
                      </div>
                      <div class='col-sm-2'>
        ...
        <div class='panel-body'>
          <form class='form-horizontal' action='#' method='post' enctype='multipart/form-data'>
            ...
            <div class='form-group'>
              ...
              <div class='col-sm-5'>
                <input class='form-control' id='fecha_alta' type='date' name='fecha'><span></span>
              </div>
            </div>
            <div class='form-group'>
              <div class='col-sm-12 col-sm-offset-4'>
