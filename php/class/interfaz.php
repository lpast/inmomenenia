        ...
        echo "<nav class='menu navbar navbar-inverse navbar-fixed-top texto'>
                <div class='container-fluid'>
                  ...
                  <ul class='nav navbar-nav navbar-right'>
                    ...
                    <li><a href='../php/clientes/area-personal.php'><span class='glyphicon glyphicon-calendar'></span> Área Personal</a></li>
        ...
        $tipo_usuario = $_SESSION['tipo'];
          if ($tipo_usuario == 'u') {
            ...
            echo "<div class='col-xs-12 col-sm-8 col-sm-offset-2 cabecera-menu-inicio'>
                ...
                echo "</div>";
                echo "<div class='col-xs-12 col-sm-8 col-sm-offset-2 cabecera'>";
          ...
          if ($tipo_usuario == 'a') {
            ...
            <div class='col-xs-12 col-sm-8 col-sm-offset-2 cabecera'>";
            self::mostrar_noticias();
            echo "</div>";
        ...
        if (!$noticias) {
          ...
          if (!$mostrar) {
            ...
            while ($fila = mysqli_fetch_array($mostrar,MYSQLI_ASSOC)) {
              ...
              echo "<div class='panel-body tnoticias'>  
                <img align='center' class='img-responsive' src='../media/img/img_noticias/$fila[imagen]' alt='img_noticia'  width='30%' >
